export const plantillaDepositoSaldo = (nombre, monto, saldoNuevo, vendedor) => {
...
<html lang="es">
  <head>
    ...
    <title>Depósito realizado - ${process.env.APP_NAME}</title>
    ...
    <style>
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      h2 { font-size: 28px; color: #059669; margin-bottom: 20px; font-weight: 700; text-align: center; }
  ...
  <body>
    <div class="email-container">
      ...
      <div class="content">
        ...
        <p>Se ha realizado un depósito exitosamente en tu cuenta.</p>
        ...
        <p>
          Ya podés usar tu saldo para comprar boletos y participar en los sorteos. ¡Buena suerte!
        </p>
