...
import { crearUsuario } from '../controladores/crear-usuario.controlador.mjs';
import { autenticar, verificarAdministrador } from '../middlewares/auth.middleware.mjs';
import { validar } from '../middlewares/validacion.middleware.mjs';
import { validarCrearUsuario } from '../validaciones/crear-usuario.validacion.mjs';
