...
Municipio.belongsTo(Departamento, { foreignKey: "departamento", as: "departamentoInfo" });
...
Cliente.belongsTo(Departamento, { foreignKey: "departamento", as: "departamentoInfo" });
